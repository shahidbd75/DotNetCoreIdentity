...
{
    public class CustomIdentityUserRepository: UserStoreBase<IdentityUser,string,
        IdentityUserClaim<string>,IdentityUserLogin<string>,IdentityUserToken<string>>
    {
        public CustomIdentityUserRepository(IdentityErrorDescriber describer) : base(describer)
        {
        }
